...
<div class="container">
    <div class="row justify-content-center">
        <div class="col-md-8">
            <div class="card">
                <div class="card-header text-center text-bg-success">Edit Produk {{ $id }}</div>
 
                <div class="card-body-info bg-dark ">
                    <div class="row mb-2">
                    ...
                    <form method="POST" action="{{ url('/simpan_edit_produk/'.$id) }}" enctype="multipart/form-data">
                        ...
                        <div class="row mb-3">
                            <label for="nama_produk" class="col-md-4 col-form-label text-success text-md-end">Nama Produk</label>
                        ...
                        <div class="row mb-3">
                            <label for="gambar_produk" class="col-md-4 col-form-label text-success text-md-end">Gambar Produk</label>
                        ...
                        <div class="row mb-3">
                            <label for="stok" class="col-md-4 col-form-label text-success text-md-end">Stok</label>
                        ...
                        <div class="row mb-3">
                            <label for="deskripsi_produk" class="col-md-4 col-form-label text-success text-md-end">Deskripsi
                                Produk</label>
